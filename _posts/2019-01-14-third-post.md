...
![ipcluster_start](./images/ipcluster_start.png){: width="150%" height="150%"}

3. import class, module
![class&module_import](./images/class&module_import.png){: width="150%" height="150%"}

4. apply codes
![apply_codes](./images/parallel_execute_code.png){: width="150%" height="150%"}

5. verify cpu working
![cpu_status](./images/cpu_status.png){: width="100%" height="100%"}
<br/>
